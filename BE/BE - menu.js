...
📋 REQUIREMENTS:
• Master sheet must be named "BE - Master Ledger"
...
// ===============================
// 🔧 MANUAL MENU TRIGGER (for troubleshooting)
// Run this function manually if menu doesn't appear
// ===============================
function createMenu() {
  try {
    const ui = SpreadsheetApp.getUi();
    ...
    ui.createMenu("📊 Financial Manager")
      ...
      .addItem("❓ Help & Documentation", "showHelp")
      .addToUi();
    Logger.log("✅ Menu created successfully! Please refresh your spreadsheet.");
  } catch (e) {
    Logger.log("⚠️ Could not create menu from script editor. Please close and reopen your spreadsheet - the menu will appear automatically via onOpen().");
  }
}
